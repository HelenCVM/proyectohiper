...
if ($_GET != '') {
    $sql = "SELECT * FROM Producto  WHERE pro_nombre LIKE '" . $_GET['key'] . "%' AND cate_codigo='8'";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo " <td><img class='perfil' src='../../../imagenes/industrales/".$row["pro_img"].".jpg' width=' 100px'
                height=' 100px'></td>";
