...
<head>
    ...
    <title> Lista de Facturas Anuladas</title>
...
<body>
    ...
    <section id="container">
        <h1><i class="fas fa-archive"></i> Lista de Facturas Anuladas</h1>
...
$sql = "SELECT f.fac_codigo,f.fac_fecha, f.fac_total,f.fac_estado, u.usu_nombres,f.usu_codigo , u.usu_apellidos FROM Factura f INNER JOIN Usuario u ON f.usu_codigo= u.usu_codigo AND f.fac_eliminado='S'";
...
if ($result->num_rows > 0) {
    ...
    echo "<tr>";
    echo '<td colspan="6" class="db_null"><p>No existen Facturas Anuladas</p><i class="fas fa-exclamation-circle"></i></td>';
    echo "</tr>";
}
$conn->close();
?>
